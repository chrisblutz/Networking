...
public class ConnectionGroup implements Iterable<Connection> {
	 ...
	 * 
	 * @param id
	 *            The id of the {@code ConnectionGroup}
	 */
	 ...
	 * 
	 * @param c
	 *            The {@code Connection} to check for
	 ...
	 * 
	 * @param sender
	 *            The {@code Connection} that sent this {@code Packet}
	 * @param data
	 ...
	 *            The {@code Packet} to send
	 * @param groups
	 *            All {@code ConnectionGroups} to check through. If the group
