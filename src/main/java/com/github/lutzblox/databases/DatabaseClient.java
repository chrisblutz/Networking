...
public class DatabaseClient {
     ...
     * @param port                 The port of the server to connect to when {@code connect()} is
     *                             called
     * @param responseLoopWaitTime The amount of time to wait for a response from the server
     */
     ...
     *
     * @param key The key of the value to request
     ...
     * Puts a value into the database
     *
     * @param putRequest The {@code PutRequest} to add
     */
     ...
     * Deletes a value from the database
     *
     * @param deleteRequest The {@code DeleteRequest} to add
     */
