...
public class ExtendedMap {
	 ...
	 * @param key
	 *            The key of the object being added
	 * @param object
	 *            The value of the object being added
	 */
	 ...
	 * 
	 * @param type
	 *            The type to remove the combination from
	 * @param key
	 *            The key to remove
	 */
